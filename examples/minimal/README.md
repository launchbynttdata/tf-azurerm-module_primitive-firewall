...
| <a name="input_resource_names_map"></a> [resource\_names\_map](#input\_resource\_names\_map) | A map of key to resource\_name that will be used by tf-launch-module\_library-resource\_name to generate resource names | <pre>map(object({<br/>    name       = string<br/>    max_length = optional(number, 60)<br/>    region     = optional(string, "centralus")<br/>  }))</pre> | <pre>{<br/>  "firewall": {<br/>    "name": "fw",<br/>    "region": "centralus"<br/>  },<br/>  "firewall_policy": {<br/>    "name": "fwpolicy",<br/>    "region": "centralus"<br/>  },<br/>  "public_ip": {<br/>    "name": "ip",<br/>    "region": "centralus"<br/>  },<br/>  "resource_group": {<br/>    "name": "rg",<br/>    "region": "centralus"<br/>  },<br/>  "virtual_network": {<br/>    "name": "vnet",<br/>    "region": "centralus"<br/>  }<br/>}</pre> | no |
